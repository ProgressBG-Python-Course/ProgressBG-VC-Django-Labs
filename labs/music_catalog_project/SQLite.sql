...
-- Create model Album
--
CREATE TABLE "music_catalog_album" (
...
-- Create model Artist
--
CREATE TABLE "music_catalog_artist" (
  "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, 
  "name" varchar(50) NOT NULL, 
  "about" text NULL, 
  "thumbnail" varchar(100) NOT NULL, 
...
-- Create model Genre
--
CREATE TABLE "music_catalog_genre" (
  "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, 
  "name" varchar(50) NOT NULL, 
  "notes" text NULL
);
...
CREATE TABLE "music_catalog_track" (
  ...
  "lyrics" text NULL, 
  "is_fav" bool NOT NULL, 
  "album_id" integer NOT NULL REFERENCES "music_catalog_album" ("id") DEFERRABLE INITIALLY DEFERRED
);

CREATE TABLE "music_catalog_track_artist" (
  "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, 
  "track_id" integer NOT NULL REFERENCES "music_catalog_track" ("id") DEFERRABLE INITIALLY DEFERRED, 
  "artist_id" integer NOT NULL REFERENCES "music_catalog_artist" ("id") DEFERRABLE INITIALLY DEFERRED
);

--
-- Add field artist to album
--
CREATE TABLE "music_catalog_album_artist" (
  "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, 
  "album_id" integer NOT NULL REFERENCES "music_catalog_album" ("id") DEFERRABLE INITIALLY DEFERRED, 
  "artist_id" integer NOT NULL REFERENCES "music_catalog_artist" ("id") DEFERRABLE INITIALLY DEFERRED
);
...
--
CREATE TABLE "music_catalog_album_genre" (
  "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, 
  "album_id" integer NOT NULL REFERENCES "music_catalog_album" ("id") DEFERRABLE INITIALLY DEFERRED, 
  "genre_id" integer NOT NULL REFERENCES "music_catalog_genre" ("id") DEFERRABLE INITIALLY DEFERRED
);
