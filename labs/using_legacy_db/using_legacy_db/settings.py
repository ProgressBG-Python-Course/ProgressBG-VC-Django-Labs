"""
Django settings for using_legacy_db project.
...
SECRET_KEY = '^a^^3e%+^!7wv1qte05=v)6@@7%d=g9yqztzv$4#osyuuqy1-@'
...
ROOT_URLCONF = 'using_legacy_db.urls'
...
WSGI_APPLICATION = 'using_legacy_db.wsgi.application'
